...
const (
	...
	StateStartMenu                    // стартовое меню (если найдено сохранение)
...
// и анимация боссов). Генерируется таймером каждые 250 мс.
// =============================================================================
...
func (g *Game) Run() error {
	...
	// Если есть сохранение — показываем стартовое меню, иначе начинаем новую игру
	// Функция startNewGame определена в save.go
